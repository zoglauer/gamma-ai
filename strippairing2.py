...
FileName = "StripPairingSmall.x2.y2.strippairing.root"
...
Factory.BookMethod(DataLoader, ROOT.TMVA.Types.kMLP, "MLP", "!H:!V:VarTransform=Norm:NeuronType=tanh:NCycles=20000:HiddenLayers=N**2:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator" );
...
NGoodEventsTS = 0
#simulate the events
for x in range(0, min(1000, DataTree.GetEntries())):
  DataTree.GetEntry(x)
